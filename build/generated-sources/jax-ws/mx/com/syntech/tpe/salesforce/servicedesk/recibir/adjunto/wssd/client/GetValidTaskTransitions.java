 ...
 *         &lt;element name="taskHandle" type="{http://www.w3.org/2001/XMLSchema}string"/>
...
@XmlRootElement(name = "getValidTaskTransitions")
public class GetValidTaskTransitions {

    protected int sid;
    @XmlElement(required = true)
    protected String taskHandle;
    @XmlElement(required = true)
    ...
    /**
     * Obtiene el valor de la propiedad taskHandle.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Define el valor de la propiedad taskHandle.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setTaskHandle(String value) {
